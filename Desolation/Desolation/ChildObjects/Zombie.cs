...
namespace Desolation
{
    class Zombie : Entity
    {
        ...
        {
            spriteBatch.Draw(TextureManager.zombieSheet, new Vector2(position.X - 8, position.Y - 15), sourceRect, Color.White, 0f, new Vector2(), 1f, SpriteEffects.None, (float)(0.3 + (0.0001f * (position.Y - Globals.cameraPos.Y)) - 0.0003));
